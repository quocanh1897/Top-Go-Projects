...
| ---- | :----: | :-----: | ------------ |
| [cobra](https://github.com/spf13/cobra) | **13623** | **1163**  | A Commander for modern Go CLI interactions |
...
| [go-prompt](https://github.com/c-bata/go-prompt) | **2439** | **122**  | Building powerful interactive prompts in Go, inspired by python-prompt-toolkit. |
