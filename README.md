...
| [color](https://github.com/fatih/color) | **3035** | **355**  | Color package for Go (golang) |
...
| Repo | Stars  |  Forks  |  Description |
| ---- | :----: | :-----: | ------------ |
| [termui](https://github.com/gizak/termui) | **8982** | **557**  | Golang terminal dashboard |
| [gocui](https://github.com/jroimartin/gocui) | **5441** | **319**  | Minimalist Go package aimed at creating Console User Interfaces. |
| [termbox-go](https://github.com/nsf/termbox-go) | **3505** | **289**  | Pure Go termbox implementation |
...
| [wails](https://github.com/wailsapp/wails) | **885** | **46**  | Create desktop apps using Go and Web Technologies |
| [systray](https://github.com/getlantern/systray) | **794** | **119**  | a cross platfrom Go library to place an icon and menu in the notification area |
...
| [zerolog](https://github.com/rs/zerolog) | **2268** | **152**  | Zero Allocation JSON Logger |
...
| [db](https://github.com/upper/db) | **1873** | **141**  | Productive data access layer for Go. |
| [reform](https://github.com/go-reform/reform) | **807** | **44**  | A better ORM for Go, based on non-empty interfaces and code generation. |
| [pop](https://github.com/gobuffalo/pop) | **689** | **167**  | A Tasty Treat For All Your Database Needs |
...
| [go-swagger](https://github.com/go-swagger/go-swagger) | **4024** | **657**  | Swagger 2.0 implementation for go |
| [goa](https://github.com/goadesign/goa) | **3522** | **401**  | Design-based APIs and microservices in Go |
...
| [gizmo](https://github.com/nytimes/gizmo) | **2856** | **180**  | A Microservice Toolkit from The New York Times |
...
| Repo | Stars  |  Forks  |  Description |
| ---- | :----: | :-----: | ------------ |
| [leaf](https://github.com/name5566/leaf) | **3083** | **867**  | A game server framework in Go (golang) |
